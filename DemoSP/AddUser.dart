...
class _AddUserState extends State<AddUser> {
                      ...
                      onPressed: () {
                        setState(
                            ...
                            if (formkey.currentState!.validate()) {
                              setUserDetails(islogin: true);
                              // Navigator.of(context).pop(map);
                            }
                            else{
                              setUserDetails(islogin: false);
                            }
                          },
                        );
                      },
  ...
  Future<void> setUserDetails({islogin}) async {
      var pref = await SharedPreferences.getInstance();
      pref.setBool('IsUserAdded', islogin);
      print(pref.getBool('IsUserAdded'));
  }
}
